Shader "Unlit/jiaoku_gl"
{
    Properties
    {
        ...
        ReflectionProbeA("ReflectionProbeA", 2D) = "white"{}
        ReflectionProbeB("ReflectionProbeB", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // #include "glsl/jiaoku_01_vert.glsl"
            // #include "glsl/jiaoku_01_frag.glsl" 
#ifdef VERTEX
...
layout(location = 0)out vec3 v2f_position_local;
layout(location = 1)out vec3 v2f_position_world;
layout(location = 2)out vec4 v2f_position_screen;
layout(location = 3)out vec4 v2f_vertex_color;
layout(location = 4)out vec3 v2f_normal;
...
#define normal NORMAL0
#define tangent TANGENT0
vec3 _1316 = vec3(0.0);
...
void main()
{
    _entryPointOutput = vec4(1.0,1.0,1.0,1.0);
    return;
